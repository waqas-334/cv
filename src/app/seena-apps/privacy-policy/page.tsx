    ...
    <>
      <GoogleAnalytics
        ...
        eventParams={{
          ...
          page_path: "/shiftedpixel/privacy-policy",
        }}
      ></GoogleAnalytics>
      <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
        <section className="mx-auto w-full max-w-2xl space-y-4 bg-white print:space-y-6">
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            Welcome to [SEENA APPS]. Your privacy is important to us. This
            Privacy Policy explains how we handle and protect the information
            you provide when using all our games.
          </p>
          <br></br>
          ...
          <ul className="text-pretty font-mono text-sm text-muted-foreground">
            ...
            <li>
              • Game performance metrics (e.g., crash reports, usage
              statistics).{" "}
            </li>
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            ...
            recommend reviewing the privacy policies of these ad networks for
            more information about their practices. Following is the list of ad
            networks we use:
            <ul>
              <li>
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            ...
            provided personal information, please contact us, and we will
            promptly delete it.
          </p>
          <br></br>
          <h3 className="text-xl font-bold">Your Consent</h3>
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            By playing our game, you consent to this Privacy Policy and the use
            of anonymous data as described.
          </p>
          <br></br>
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            ...
            <br />
            Website:
            <a href="https://waqasyounis.com">WaqasYounis</a>
            <br />
            <br />
            Thank you!
          </p>
